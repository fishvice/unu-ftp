...
The following is just a documentation of how the data that were used in the classroom were compiled. Ergo, the code below is just for bookeeping - don't expect that you can reproduce it.
